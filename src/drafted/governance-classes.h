 ...
 *
 *   // network
 *   CLINCNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.linc.site/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CLINCNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: LINCNetwork
// //   -- signature requirements : Key1(User)
// class CLINCNetworkVariable : public CGovernanceObject
// {
// private:
