    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("LINC Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About LINC Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  linc-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the LINC in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 LINC, 0.1 LINC, 1 LINC and 10 LINC -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("LINC Core is shutting down...") + "<br /><br />" +
