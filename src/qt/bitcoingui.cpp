    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("LINC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a LINC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and linc: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About LINC Core"), this);
    aboutAction->setStatusTip(tr("Show information about LINC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for LINC Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your LINC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified LINC addresses"));
    ...
    openAction->setStatusTip(tr("Open a linc: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/" + theme + "/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the LINC Core help message to get a list with possible LINC Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("LINC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LINC network", "", count));
}
...
{
    QString strTitle = tr("LINC Core"); // default title
