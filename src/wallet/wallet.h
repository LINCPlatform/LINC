...
enum AvailableCoinsType
{
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT2500IFMN = 3,
    ONLY_NONDENOMINATED_NOT2500IFMN = 4,
    ONLY_2500 = 5, // find masternode outputs including locked ones (use with caution)
...
public:
    ...
    /// Get 2500LINC output and keys which can be used for the Masternode
