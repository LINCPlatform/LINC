...
2. run lincd with -printalert or -sendalert like this:
   /path/to/lincd -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.linc.site";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/LINC Core:0.12.0.58/"));
